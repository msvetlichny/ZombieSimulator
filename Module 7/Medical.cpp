...
Medical::Medical(int total_population, int X, int Y, int Z, int Q, int P, int R) {
	...
	for (int i = 0; i < current_population; i++) {
		...
		std::cout << "successfully loaded ignorant persons into Medical Hill" << std::endl;
		std::cout << "Successfully loaded 1 zombie into Medical Hill" << std::endl;
	}
}
